...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #one hot encoding is used to get the softmax output over the 3 channels of the output. 
        #there are num_dates*n_classes channels in the output, the first n_classes channels are for the first date, 
        #the second n_classes channels are for the second date and so on to the num_dates date.
        #
